...
Generated from `_dev/build_chart_references.R` on 2026-09-14. Do not edit this file by hand: add a snippet to `_dev/r.snippets`, describe it in that script's `catalogue` and `picker` tables, and run `Rscript _dev/build_chart_references.R`.
