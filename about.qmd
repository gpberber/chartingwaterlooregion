---
title: "About"
# No `image:` here on purpose. It set the mark beside the heading, but Quarto also
# uses it as the page's preview picture, so a link to this page arrived in a chat
# app as a bare SVG that nothing could render. Without it the page falls back to
# the site card in _quarto.yml, the same as every other page. `marquee` stays -
# solana and trestle both narrow the prose below a post's width.
about:
  template: marquee
  links:
    - icon: github
