...
Replace `<post-slug>` with the folder name shown in the URL of the post, for example `kitchener-phone-wait-times`. The README in each post folder lists the original sources and their licences.
...
- **Questions.** Email [greg@chartingwaterlooregion.ca](mailto:greg@chartingwaterlooregion.ca) if something does not work.
