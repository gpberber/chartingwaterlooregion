...
- The cattle and census population tables are cut to Waterloo Region as they are downloaded,
  unlike the other raw files; nothing outside those rows is used.
...
- Sampling: none of the figures are from a sample. The population estimates are Statistics
  Canada's demographic estimates, not a survey. The Census of Agriculture counts every farm, and the
  2021 township populations beside the cattle are the census full count.
