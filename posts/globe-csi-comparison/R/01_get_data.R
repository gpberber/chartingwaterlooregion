# 01_get_data.R
# Fetches every raw input for the "Title: to be written" post into data-raw/.
# data-raw/ is gitignored, so this script is how a reader (or future you)
# recreates it. Run from the project root: source("posts/globe-csi-comparison/R/01_get_data.R")

library(tidyverse)
library(here)

raw_dir <- here("posts", "globe-csi-comparison", "data-raw")
...
# cwr_data_download("globe-csi-comparison", kind = "data-raw")
