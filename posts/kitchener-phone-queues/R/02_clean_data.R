here::i_am("posts/kitchener-phone-queues/R/02_clean_data.R")
...
holidays <- read_csv(here("posts", "kitchener-phone-queues", "data-raw", "holidays.csv")) |> 
...
# Read the raw file
raw_text <- readLines(here("posts", "kitchener-phone-queues", "data-raw", "kitchener_phone_queue_metrics.csv"))
