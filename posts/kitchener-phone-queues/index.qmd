...
date: "2025-02-05"
categories: [Deep dive, Open Data, City Services, Kitchener]
draft: false
---
...
Code and data for this post: [`posts/kitchener-phone-queues/`](https://github.com/gpberber/chartingwaterlooregion/tree/master/posts/kitchener-phone-queues) on GitHub. See [Reproduce a post](../../reproduce.qmd) for the steps.

**Download the data:** [`r cwr_bundle_name("kitchener-phone-queues", data_bundle_version)`](`r cwr_bundle_url("kitchener-phone-queues", data_bundle_version)`) holds every table used in this post as CSV and Parquet files, an Excel workbook, the data dictionary below, and a README with sources and licences.

```{r}
#| label: tbl-dictionary
#| tbl-cap: "Data dictionary for the tables used in this post."

cwr_dictionary_table("kitchener-phone-queues")
```
