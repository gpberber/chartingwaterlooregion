...
school_collisions |> 
  ...
  #summarise(num_ped_collisions = sum(pedestrianinvolved)) |>
  mutate(accident_year = factor(accident_year, levels = c("2015", "2016", "2017", "2018", "2019", "2020", "2021", "2022"))) |>
...
all_collisions |> 
  ...
  ggplot(aes(x = accident_year, y = num_ped_collisions)) +
