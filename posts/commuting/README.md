...
- The industry chart is 2016 only, from the same table: 98-400-X2016321 is what crosses place of work status with industry for the Region, and its industry dimension is the 20 sectors of NAICS 2012. The chart ranks the ten sectors with the largest share of their own workers working at home; the table's total-industry row is left out, being the Region-wide share the chart above already gives. The 2021 census does publish the equivalent (table 98-10-0456, place of work status by industry sectors, occupation broad category and gender, for census divisions and subdivisions), so the same ranking could be drawn for 2021 or for both years if the post wants it. Two cautions on the 2016 ranking: finance and insurance (7.81%) and wholesale trade (7.79%) are separated by about two hundredths of a point, which is well inside what random rounding alone can move; and management of companies and enterprises is a small sector here, 465 workers, so its 11.8% rests on a rounded count of 55.
