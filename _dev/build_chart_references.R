...
picker <- tribble(
  ...
  "gghorbar",            "chart", "Horizontal bar chart, ranked",      "A ranking - and the default whenever the category names are long or there are more than about six of them: municipalities, offence types, wards.",
